...
export class Mouse {
    ...
    get entity() {
        if (this.state === "die") {
            return "/images/mice/" + this.name + "/" + this.state + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/" + this.state + (this.critical ? "_critical" : "") + "." + this.assetFormat;
        }
    }
    // ===== 状态效果系统 =====
    // 减速效果
    ...
    // 爬梯子效果
    ignoring = false;
    ignoringTargetPositionX;
    ignoringFullDistance;
    ignoringBeforeSpeed;
    ignoringBeforeTop;
    ignoringCurrentDistance;
    // ===== 状态判断 =====
    get CanUpdateEntity() {
    ...
    // ===== 换行系统 =====
    changeLine(pos, animation = false) {
    ...
    frozenProcess() {
        if (this.frozen) {
            ...
            if (this.frozen) {
                const img = GEH.requestDrawImage("/images/interface/ice.png");
                if (img) {
                    this.ctx.drawImage(img, level.column_start + this.positionX * level.row_gap - 12, level.row_start + (this.row + 1) * level.column_gap - 32, img.width, img.height);
                }
            }
            else {
                level?.createSpriteAnimation(level.column_start + (this.positionX - 1) * level.row_gap - 24, level.row_start + this.row * level.column_gap - 8, "/images/interface/ice_break.png", 6, { zIndex: this.row * level.column_num + this.column });
    ...
    haltedProcess() {
        if (this.halted) {
            ...
            if (img) {
                this.ctx.drawImage(img, level.column_start + (this.positionX - 1) * level.row_gap + 42, level.row_start + this.row * level.column_gap - 32, img.width, img.height);
            }
    ...
    getBlast(value = 20) {
        ...
        if (this.state === this.stateSet[2]) {
            ...
            level?.createSpriteAnimation(this.positionX * 60 + 300, this.row * 64 + 78, "/images/interface/ash.png", 15, { zIndex: this.row * level.column_num + this.column });
        }
    }
    ...
    getHalted(length = 5000, attachment = null) {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            ...
            if (this.state === this.stateSet[3]) {
                ...
                return "/images/mice/" + this.name + "/" + this.state + "_" + this.unarmoredFrom + "." + this.assetFormat;
            }
            else {
                return "/images/mice/" + this.name + "/" + this.state +
                    (this.critical ? "_critical" : (this.armored ? ("_armored" +
                        (this.armorCritical ? "_critical" : "")) : "")) + "." + this.assetFormat;
            }
        }
    }
    height = 135;
...
class WaterMouse extends Mouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            return "/images/mice/" + this.name + "/" + this.state + (this.inWater ? "_inwater" : "") + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/" + this.state + (this.inWater ? "_inwater" : "")
                + (this.critical ? "_critical" : "") + "." + this.assetFormat;
        }
    }
    constructor(x = 0, y = 0) {
        super(x, y);
    ...
    rippleAnim() {
        ...
        if (ripple) {
            this.ctx.drawImage(ripple, 72 * this.rippleTick, 0, 72, 39, this.x + 9, this.y + 75, 72, 39);
        }
    }
    behaviorAnim() {
        if (this.inWater) {
...
class SkatingMouse extends Mouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            ...
            return "/images/mice/" + this.name + "/" + this.state +
                (this.jumped ? "_jumped" : "") + (this.critical ? "_critical" : "") + "." + this.assetFormat;
        }
    }
    get critical() {
...
class KangarooMouse extends Mouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            return "/images/mice/" + this.name + "/" + this.state + (this.stopped ? "_stopped" : "") + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/" + this.state + (this.stopped ? "_stopped" : "")
                + (this.critical ? "_critical" : "") + "." + this.assetFormat;
        }
    }
    get critical() {
...
class DiveMouse extends WaterMouse {
    ...
    rippleAnim() {
        const ripple = GEH.requestDrawImage(this.ripple);
        if (ripple) {
            this.ctx.drawImage(ripple, 72 * this.rippleTick, 0, 72, 39, this.x + 15, this.y + 110, 72, 39);
        }
    }
    behaviorAnim() {
        if (this.inWater) {
...
class FrogMouse extends WaterMouse {
    ...
    rippleAnim() {
        const ripple = GEH.requestDrawImage(this.ripple);
        if (ripple) {
            this.ctx.drawImage(ripple, 72 * this.rippleTick, 0, 72, 39, this.x + 9, this.y + 125, 72, 39);
        }
    }
    behaviorAnim() {
        if (this.inWater) {
...
class FootballFanMouseWater extends WaterMouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            return "/images/mice/" + this.name + "/"
                + this.state + (this.inWater ? "_inwater" : "") + "." + this.assetFormat;
        }
        else if (this.state === this.stateSet[4]) {
            return "/images/mice/" + this.name + "/"
                + this.state + (this.inWater ? "_inwater" : "")
                + "_" + this.unarmorFrom + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/"
                + this.state + (this.inWater ? "_inwater" : "")
                + (this.armored ? ("_armored" +
                    (this.armorCritical ? "_critical" : "")) : (this.critical ? "_critical" : "")) + "." + this.assetFormat;
        }
    }
    constructor(x = 0, y = 0) {
        super(x, y);
    ...
    rippleAnim() {
        const ripple = GEH.requestDrawImage(this.ripple);
        if (ripple) {
            this.ctx.drawImage(ripple, 72 * this.rippleTick, 0, 72, 39, this.x + 4, this.y + 100, 72, 39);
        }
    }
    behaviorAnim() {
        if (this.inWater) {
...
class PanMouseWater extends FootballFanMouseWater {
    ...
    rippleAnim() {
        const ripple = GEH.requestDrawImage(this.ripple);
        if (ripple) {
            this.ctx.drawImage(ripple, 72 * this.rippleTick, 0, 72, 39, this.x + 12, this.y + 110, 72, 39);
        }
    }
    getHit(value = 20) {
        if (this.armored) {
...
class SinkMouse extends ArmoredMouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            return "/images/mice/" + this.name + "/" + this.state + (this.armored ? "_armored" : "") + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/" + this.state + (this.critical ? "_critical" : "")
                + (this.armored ? ("_armored" + (this.armorCritical ? "_critical" : "")) : "") + "." + this.assetFormat;
        }
    }
    constructor(x = 0, y = 0) {
        super(x, y);
...
class PotMouse extends SinkMouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            ...
            return "/images/mice/" + this.name + "/" + this.state + (this.critical ? "_critical" : "")
                + (this.armored ? "_armored" : "") + "." + this.assetFormat;
        }
    }
    constructor(x = 0, y = 0) {
        super(x, y);
    ...
    getFreezingHit(value = 20, length) {
        GEH.requestPlayAudio("commonhit");
        if (!this.armored) {
            this.getFreezing(length);
        }
...
class NinjaMouse extends Mouse {
    ...
    get entity() {
        if (this.state === 'die') {
            ...
            return "/images/mice/" + this.name + "/" + this.state + (this.summoned ? "_summoned" : "")
                + (this.critical ? "_critical" : "") + "." + this.assetFormat;
        }
    }
    constructor(x = 0, y = 0) {
...
class RepairMouse extends SinkMouse {
    ...
    get entity() {
        if (this.state === this.stateSet[2]) {
            ...
            if (this.state === this.stateSet[4]) {
                return "/images/mice/" + this.name + "/" + this.state + (this.critical ? "_critical" : "")
                    + "_armored" + (this.armorCritical ? "_critical" : "") + "." + this.assetFormat;
            }
            else {
                return "/images/mice/" + this.name + "/" + this.state + (this.critical ? "_critical" : "")
                    + (this.armored ? ("_armored" + (this.armorCritical ? "_critical" : "")) : "") + "." + this.assetFormat;
    ...
    attackCheck() {
        ...
        if (this.armored && this.state !== this.stateSet[4]) {
            if (this.generateTarget) {
                if (this.generateTarget.getShieldType()
                    && !this.generateTarget.getShieldType().ignored) {
                    this.generateTarget = this.generateTarget.getShieldType();
                    this.generateLadder();
                }
            }
        }
        ...
        if (this.state === this.stateSet[4]) {
            if (this.tick === this.stateLength - 1) {
                if (this.generateTarget && !this.generateTarget.ignored) {
                    this.generateTarget.ignore("ladder" + (this.armorCritical ? "_critical" : ""));
                }
                this.state = this.stateSet[0];
                this.tick = 0;
            }
    ...
    get entity() {
        if (this.state === 'die') {
            ...
            if (this.critical) {
                ...
                return "/images/mice/" + this.name + "/" + this.state + "_critical" + "." + this.assetFormat;
            }
            else {
...
class RogueMouse extends Mouse {
    ...
    get sign() {
        return "/images/mice/" + this.name + "/sign.png";
    }
    rope;
    get entity() {
        if (this.state === this.stateSet[2]) {
            return "/images/mice/" + this.name + "/" + "idle" + "." + this.assetFormat;
        }
        else {
            return "/images/mice/" + this.name + "/" + this.state + "." + this.assetFormat;
        }
    ...
    behaviorAnim() {
        if (this.CanUpdateEntity) {
            ...
            if (sign) {
                this.ctx.drawImage(sign, 62 * this.tick, 0, 62, 60, this.column * 60 + 300, this.y, 62, 60);
            }
            if (this.state === this.stateSet[0]) {
                ...
                if (!this.attackable) {
                    ...
                    this.y -= 40;
                    if (this.target) {
                        const ctx = level.Battlefield.ctxBG;
                        if (this.target.layer_0) {
                            this.target.layer_0.y -= 40;
                            const img = GEH.requestDrawImage(this.target.layer_0.inside);
                            if (img) {
                                ctx.drawImage(img, this.target.layer_0.x, this.target.layer_0.y, img.width, img.height);
                            }
                        }
                        if (this.target.layer_2) {
                            ...
                            if (img) {
                                ctx.drawImage(img, this.target.layer_2.width * this.target.layer_2.tick, 0, this.target.layer_2.width, this.target.layer_2.height, this.target.layer_2.x, this.target.layer_2.y, this.target.layer_2.width, this.target.layer_2.height);
                            }
                        }
                        if (this.target.layer_1) {
                            ...
                            if (img) {
                                ctx.drawImage(img, this.target.layer_1.width * this.target.layer_1.tick, 0, this.target.layer_1.width, this.target.layer_1.height, this.target.layer_1.x, this.target.layer_1.y, this.target.layer_1.width, this.target.layer_1.height);
                            }
                        }
                        if (this.target.layer_0) {
                            const img = GEH.requestDrawImage(this.target.layer_0.entity);
                            if (img) {
                                ctx.drawImage(img, this.target.layer_0.width * this.target.layer_0.tick, 0, this.target.layer_0.width, this.target.layer_0.height, this.target.layer_0.x, this.target.layer_0.y, this.target.layer_0.width, this.target.layer_0.height);
                            }
                        }
                    }
                    if (this.y <= 0) {
...
class MarioMouse extends BossMouse {
    ...
    behaviorAnim() {
        if (this.progress) {
            ...
            if (this.progress.__lastWidth !== widthPx) {
                this.progress.style.width = widthPx;
                this.progress.__lastWidth = widthPx;
            }
        }
        if (this.state === "idle") {
            this.x = 800;
...
class TubeOut extends Obstacle {
    ...
    get entity() {
        return "/images/interface/" + this.name + (this.critical ? "_critical" : "") + "." + this.assetFormat;
    }
    constructor(x = 0, y = 0) {
        super(x, y);
        this.x = x * 60 + 280;
...
const landSummon = function (item, x = 9, y = -1) {
    const { GameEnd } = GEH;
    if (!level || GameEnd) {
        return false;
    }
...
const waterSummon = function (item, x = 9, y = -1) {
    const { GameEnd } = GEH;
...
const foodPosSummon = function (item) {
    const { GameEnd } = GEH;
    if (!level || GameEnd) {
        return false;
    }
...
export const getMouseDetails = function (type = 0) {
    switch (type) {
        case 0:
        case "commonmouse":
            return {
