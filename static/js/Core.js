...
import { CANCEL, DAYTIME, GAME_ERROR_CODE_008, GAME_ERROR_CODE_009, GAME_UI_BUTTON_002, GAME_UI_BUTTON_003, NIGHTTIME, RESELECT, START_GAME, WATERLINE } from "./language/Chinese.js";
...
export class MaterialSwitch extends HTMLElement {
    ...
    constructor(target = null, value = false) {
        ...
        `;
        let mouse_start_x = undefined;
        let mouse_input_x = undefined;
        const thumb_reset = () => {
            if (this.value) {
...
export class MaterialDescription extends HTMLElement {
    ...
    #button = document.createElement('a');
    #close = new MaterialIconButton((EventHandler.icons).get('close'), () => {
        this.hide();
    });
    timer;
    Style;
