...
export class SpriteBatcher {
    ...
    private static readonly VERTICES_PER_SPRITE = 6;

    constructor(gl: WebGLRenderingContext, program: WebGLProgram, maxSprites: number = 1000) {
        this.gl = gl;
    ...
    addSprite(
        ...
        // 三角形1
        d[offset + 0] = dx; d[offset + 1] = dy; d[offset + 2] = u0; d[offset + 3] = v0;
        d[offset + 4] = alpha; d[offset + 5] = hit; d[offset + 6] = frozen; d[offset + 7] = mirrored;

        d[offset + 8] = dx + dw; d[offset + 9] = dy; d[offset + 10] = u1; d[offset + 11] = v0;
        d[offset + 12] = alpha; d[offset + 13] = hit; d[offset + 14] = frozen; d[offset + 15] = mirrored;

        d[offset + 16] = dx; d[offset + 17] = dy + dh; d[offset + 18] = u0; d[offset + 19] = v1;
        d[offset + 20] = alpha; d[offset + 21] = hit; d[offset + 22] = frozen; d[offset + 23] = mirrored;

        // 三角形2
        d[offset + 24] = dx; d[offset + 25] = dy + dh; d[offset + 26] = u0; d[offset + 27] = v1;
        d[offset + 28] = alpha; d[offset + 29] = hit; d[offset + 30] = frozen; d[offset + 31] = mirrored;

        d[offset + 32] = dx + dw; d[offset + 33] = dy; d[offset + 34] = u1; d[offset + 35] = v0;
        d[offset + 36] = alpha; d[offset + 37] = hit; d[offset + 38] = frozen; d[offset + 39] = mirrored;

        d[offset + 40] = dx + dw; d[offset + 41] = dy + dh; d[offset + 42] = u1; d[offset + 43] = v1;
        d[offset + 44] = alpha; d[offset + 45] = hit; d[offset + 46] = frozen; d[offset + 47] = mirrored;
